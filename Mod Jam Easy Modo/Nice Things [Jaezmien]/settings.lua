...
-- [?] (OpenITG, V1, V2, V3, V3.1, V4, V4.0.1). Defaults to the lastest NotITG version this template handles.
...
-- config.force_twoplayers = false

-- [?] Set allowed resolution ratios. By default this check is disabled.
...
-- [?] (V3.1 below), allow players with D3D enabled.
-- config.allow_d3d_render = not FUCK_EXE

-- [?] OpenITG compatibility for modreaders.lua
-- config.default_modreader = { 'exschwasion' }
